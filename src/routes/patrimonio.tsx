...
import { DirpfPdfParseError, parseDirpfPdf } from "@/lib/dirpfPdfParser";
  ...
  const processFile = useCallback(
    async (file: File | undefined | null) => {
      ...
      try {
        ...
        if (totalItems === 0) {
          setReadInfo("PDF lido, mas nenhum bem, direito ou dívida foi reconhecido.");
          toast.info("PDF lido, mas nenhum bem, direito ou dívida foi reconhecido.");
        } else {
          setReadInfo(null);
