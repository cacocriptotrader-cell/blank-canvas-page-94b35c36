  ...
  const processFile = useCallback(
    async (file: File | undefined | null) => {
      ...
      try {
        ...
        if (totalItems === 0) {
          const msg = `PDF lido pelo parser sem worker (${DIRPF_PARSER_VERSION}), mas o layout desta declaração ainda não foi reconhecido. Verifique o console para detalhes.`;
          setReadInfo(msg);
          toast.info(msg);
        } else {
          setReadInfo(null);
